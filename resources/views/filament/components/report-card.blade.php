...
@else
    @php
        $externalUrl = $report->url ?? $report->metadata['url'] ?? Storage::disk(config('filesystems.default'))->url($path);
        ...
        $base64Data = FilamentUI::getReportBase64DataUrl($report);
    @endphp
    ...
    <div x-data="{
        ...
        <div style="display: flex; align-items: center; border: 1px solid #10b981; border-radius: 12px; padding: 12px 16px; background-color: #ecfdf5; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); gap: 16px;">
            ...
            <div style="flex-grow: 1; text-align: left; min-width: 0;">
                <h4 style="font-size: 13px; font-weight: 700; color: #065f46; margin: 0 0 2px 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
            ...
            <div style="display: flex; gap: 8px; flex-shrink: 0;">
                <button @click="open = true; initBlob('{{ $base64Data }}'); $event.preventDefault();"
                        style="cursor: pointer; display: inline-flex; align-items: center; justify-content: center; padding: 6px 12px; border: 1px solid #68d391; border-radius: 8px; font-size: 12px; font-weight: 600; color: #047857; background-color: #ffffff; text-decoration: none; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); transition: background-color 0.2s;"
                ...
                <a href="{{ $downloadUrl }}" download rel="noreferrer"
                   style="display: inline-flex; align-items: center; justify-content: center; padding: 6px 12px; border: 1px solid #10b981; border-radius: 8px; font-size: 12px; font-weight: 600; color: #ffffff; background-color: #10b981; text-decoration: none; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); transition: background-color 0.2s;"
                   onmouseover="this.style.backgroundColor='#059669'" onmouseout="this.style.backgroundColor='#10b981'">
                    <svg style="width: 14px; height: 14px; margin-right: 6px;" fill="none" viewBox="0 0 24 24"
